...
class ReleasesControllerTest < ActionController::TestCase
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post :create, release: { credits: @release.credits, details: @release.details, link: @release.link, name: @release.name }
    end
  ...
  test "should update release" do
    patch :update, id: @release, release: { credits: @release.credits, details: @release.details, link: @release.link, name: @release.name }
    assert_redirected_to release_path(assigns(:release))
  end
